...
After introducing [the traditional ACLs in a recent post]({{site.url}}/ncs5500/tutorials/security-acl-on-ncs5500-part1/), let's focus on an interesting approach offering significantly higher scale and better flexibility: the hybrid ACLs.
