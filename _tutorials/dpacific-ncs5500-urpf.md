...
| November 2020 | Change of configuration in 7.x {: .notice--info} |
| December 2020 | decommission the "internet-optimized" mode, please check this article: [https://xrdocs.io/ncs5500/tutorials/decommissioning-internet-optimized-mode/](https://xrdocs.io/ncs5500/tutorials/decommissioning-internet-optimized-mode/) {: .notice--danger} |
| June 2024 | Added section about S-RTBH support {: .notice--info} |
...
| 7.5.2 | J2 based platform (with eTCAM) | `hw-module fib urpf disable` command have been introduced to provide the possibility of globally disable URPF and S-RTBH (require router reload)|
| 24.4.1 | J/J+ based platform | Support for S-RTBH will be introduced for J/J+ platforms and enabled based on the ingress interface configuration command `ipv[46] verify unicast source reachable-via any` |
| TBD | J2 based platform (with eTCAM) | Interface command `ipv[46] verify unicast source reachable-via any` requirement is enforced for J2 platform as well to achieve consistency |
