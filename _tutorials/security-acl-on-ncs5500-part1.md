...
The number of ACLs and ACEs we support is expressed per NPU (Qumran-MX, Jericho, Jericho+). Since the ACLs are applied on ports, we invite you to check [the former blog post describing the port to NPU assignments]({{site.url}}/ncs5500/tutorials/port-assignments-on-ncs5500-platforms/).
